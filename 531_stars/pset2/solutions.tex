...
\answer{
    ...
    \begin{center}
        \begin{tabular}{c|c|c}
            ...
            \hline
            Hydrogen & $4 \ce{^{1}H} \to \ce{^{4}He}$ & 0.00712 \\
            Helium & $3 \ce{^{4}He} \to \ce{^{12}C}$ & 0.00065 \\
            Carbon & $\ce{^{12}C} + \ce{^{4}He} \to \ce{^{16}O}$ & 0.00048 \\
            Oxygen & $2 \ce{^{16}O} \to \ce{^{28}Si} + \ce{^{4}He}$ & 0.00032 \\
            Silicon & $2 \ce{^{28}Si} \to \ce{^{56}Fe}$ & 0.00034 \\
        \end{tabular}
    \end{center}
