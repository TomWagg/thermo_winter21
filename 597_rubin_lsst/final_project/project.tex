...
\subsection{New parameters to consider in scoring}
...
\begin{itemize}
    ...
    \item Apparent magnitude is correlated with distance
    \item Show plots of all of them
\end{itemize}
